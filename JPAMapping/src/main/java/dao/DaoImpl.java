...
public class DaoImpl implements dao{
    ...
    public void inser() throws IOException, ParseException {
        ...
        do {
            ...
            if (choice == 1) {
                ...
                Account customer=new Account(type,status,balance,datepulish,user);
    ...
    public void updateAccountStatus() {
        ...
        subquery.where(criteriaBuilder.greaterThan(subqueryRoot.<Integer>get("Balance"), 1000000));
    ...
    public void funt() throws IOException {
        EntityManager entityManager = entityManagerFactory.createEntityManager();
        entityManager.getTransaction().begin();
        try {
            System.out.println("Enter account ID : ");
            ...
            if (accountType.equalsIgnoreCase("current")) {
                int balance = account.getAccount_balance();
