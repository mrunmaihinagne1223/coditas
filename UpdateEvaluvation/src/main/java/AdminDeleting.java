...
public class AdminDeleting extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<br>");
            PreparedStatement pt32 = con.prepareStatement("insert into  backup(id,name, email, password, city, phone)values(?,?,?,?,?,?)");
            pt32.setInt(1,did);
            pt32.setString(2,name);
            pt32.setString(3,email);
            pt32.setString(4,pwd);
            pt32.setString(5,city);
            pt32.setString(6,phone);
            pt32.executeUpdate();
